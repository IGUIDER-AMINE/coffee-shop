        ...
        <div className="container mx-auto space-y-8 px-4">
          ...
          <div className="flex gap-x-4">
            <div className="font-titleFont">
              ...
              <div className="text-[#A6A9AB]">Private Room</div>
            </div>
            <div className="font-titleFont">
              <div className="text-white text-6xl">
                25<span className="text-[#D49C66] font-light">+</span>
              </div>
              <div className="text-[#A6A9AB]">Event Space</div>
            </div>
            <div className="font-titleFont">
              <div className="text-white text-6xl">
                15<span className="text-[#D49C66] font-light">+</span>
              </div>
              <div className="text-[#A6A9AB]">Creative Studio</div>
            </div>
          </div>
        </div>
      </div>
